...
def train(args):
    ...
    with tf.Session(config=config):
        ...
        while True:
            ...
            # produces a list of each worker's (grads, params) from their environment
            # each list should be of length 12
            ...
            if interval % 5 == 0:
                ...
                savepath = osp.join(checkdir, '%.5i' % interval)
